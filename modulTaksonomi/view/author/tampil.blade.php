    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <div class="card shadow mb-4">
            ...
            <form action="{{route('adminAuthorUbah',$author->idAuthor)}}" method="post">
            @csrf
              <!-- Hidden -->
              <div class="form-group">
                <input class="form-control" type="hidden" placeholder="" name="authorHidden" value="{{$author->nama}}">
              </div>
              <!-- Hidden -->
              <div class="form-group">
                <label for="author">Author</label>
                <input class="form-control" type="text" placeholder="" name="author" value="{{$author->nama}}">
              </div>
