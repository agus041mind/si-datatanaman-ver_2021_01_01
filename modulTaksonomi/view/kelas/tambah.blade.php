          ...
          <div class="card shadow mb-4">
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="" name="kelas" value="{{old('kelas')}}">
              </div>
