    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <div class="card shadow mb-4">
            ...
            <form action="{{route('adminSubDivisiUbah',$subDivisi->idSubDivisi)}}" method="post">
            @csrf
              <!-- Hidden -->
              <div class="form-group">
                <input class="form-control" type="hidden" placeholder="" name="subDivisiHidden" value="{{$subDivisi->nama}}">
              </div>
              <!-- Hidden -->
              <div class="form-group">
                ...
                <select class="form-control select2Sindata" name="divisi">
                  ...
                  <option value="{{$item->idDivisi}}" {{$subDivisi->idDivisi == $item->idDivisi ? "selected=''" : ""}}>{{$item->nama}}</option>
                  @endforeach
                </select>
              </div>
              <div class="form-group">
                <label for="subDivisi">Sub Divisi</label>
                <input class="form-control" type="text" placeholder="" name="subDivisi" value="{{$subDivisi->nama}}">
              </div>
