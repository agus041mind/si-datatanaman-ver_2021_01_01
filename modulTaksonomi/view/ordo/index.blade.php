                ...
                <table class="table table-bordered table-striped table-sm" id="tableSindata" width="100%" cellspacing="0" style="color:#000000">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$item->kelas->subDivisi->nama}}</td>
                      <td>{{$item->kelas->subDivisi->divisi->nama}}</td>
                      <td class="text-center">
                        <a href="{{route('adminOrdoTampil',$item->idOrdo)}}">
                      ...
                      <td class="text-center">
                        <a href="{{route('adminOrdoHapus',$item->idOrdo)}}">
