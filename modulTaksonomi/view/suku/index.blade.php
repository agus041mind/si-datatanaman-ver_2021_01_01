                ...
                <table class="table table-bordered table-striped table-sm" id="tableSindata" width="100%" cellspacing="0" style="color:#000000">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$item->ordo->nama}}</td>
                      <td>{{$item->ordo->kelas->nama}}</td>
                      <td>{{$item->ordo->kelas->subDivisi->nama}}</td>
                      <td>{{$item->ordo->kelas->subDivisi->divisi->nama}}</td>
                      <td class="text-center">
                        <a href="{{route('adminSukuTampil',$item->idSuku)}}">
                      ...
                      <td class="text-center">
                        <a href="{{route('adminSukuHapus',$item->idSuku)}}">
