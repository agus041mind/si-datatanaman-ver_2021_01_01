    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <div class="card shadow mb-4">
            ...
            <form action="{{route('adminMargaUbah',$marga->idMarga)}}" method="post">
            @csrf
              <!-- Hidden -->
              <div class="form-group">
                <input class="form-control" type="hidden" placeholder="" name="sukuHidden" value="{{$marga->idSuku}}">
              </div>
              <div class="form-group">
                <input class="form-control" type="hidden" placeholder="" name="margaHidden" value="{{$marga->nama}}">
              </div>
              <!-- Hidden -->
              <div class="form-group">
                ...
                <select class="form-control select2Sindata" name="suku">
                  ...
                  <option value="{{$item->idSuku}}" {{$marga->idSuku == $item->idSuku ? "selected=''" : ""}}>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="" name="marga" value="{{$marga->nama}}">
              </div>
